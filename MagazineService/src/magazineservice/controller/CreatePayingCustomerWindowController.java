 ...
 * @author 34085068
 */
public class CreatePayingCustomerWindowController implements Initializable {
    @FXML
    ...
    @FXML
    private PayingCustomerFormController payingCustomerFormController;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        payingCustomerFormController.setEditable(true);
    }
    ...
    public void onCancelButtonClicked(ActionEvent e) {
        ...
        payingCustomerFormController.clearFields();
        currentWindow.close();
    }
